                    ...
                    {suggestedAngles.map((a, i) => (
                      <motion.button
                        ...
                        onClick={() => {
                          ...
                          // the user set in the product input form. Always
                          // route through the StylePicker; it renders gradient
                          // fallback tiles when the admin hasn't seeded real
                          // images yet, so the picker is always functional.
          ...
          <div className="max-w-[1100px] mx-auto px-5 md:px-8 py-10 md:py-14 flex flex-col gap-10">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {/* Primary CTA — open the freshly-saved pack in the Library,
                    where the user can rename, edit individual shots, or
                    publish to social channels. */}
                <Button variant="accent" size="md" onClick={() => navigate("/hub/library")}>

...
curl --request POST \
     ...
     --data '{
       ...
       "prompt": "a portrait-style photograph featuring a fox",
       "width": 1920,
       "ultra": false
     }'
Recipe
...
modelId	string	Required. UUID of the model to use. Set to 7b592283-e8a7-4c5a-9ba6-d18c31f258b9
